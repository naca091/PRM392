...
class EditBookActivity : AppCompatActivity() {
    ...
    private var currentImageSelection = 0
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_add_book) // Reusing add book layout
    ...
    private fun loadBookDetails() {
        ...
        editTextStock.setText(book.stock.toString())
        ...
        imagePath1 = book.imagePath1
        imagePath2 = book.imagePath2
        imagePath3 = book.imagePath3
        
        // Display existing images
        loadImageFromPath(imagePath1, imageView1)
        loadImageFromPath(imagePath2, imageView2)
        loadImageFromPath(imagePath3, imageView3)
    }
    ...
    private fun updateBook() {
        ...
        try {
            ...
            val result = bookRepository.updateBook(updatedBook)
